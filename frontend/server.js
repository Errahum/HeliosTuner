...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', 
    `default-src 'self'; ` +
    `script-src 'self' https://apis.google.com https://cdnjs.cloudflare.com https://stackpath.bootstrapcdn.com https://www.youtube.com https://www.gstatic.com https://www.google-analytics.com https://js.stripe.com https://www.googletagmanager.com https://challenges.cloudflare.com 'sha256-${scriptHash}'; ` +
