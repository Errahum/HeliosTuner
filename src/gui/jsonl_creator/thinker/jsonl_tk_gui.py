...
class JsonlCreatorApp(tk.Tk):
    def __init__(self):
        ...
        self.system_text.insert(tk.END, "You're an expert programming assistant.")
        ...
        self.user_text.pack()
        self.user_text.insert(tk.END, "User message")
        ...
        self.assistant_text.insert(tk.END, "Expected answer")
        ...
        self.filename_entry.insert(tk.END, "train")
